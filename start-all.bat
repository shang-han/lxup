...
echo [3/6] Starting Hermes gateway (8642)...
start "Hermes-Gateway-8642" cmd /k "cd /d D:\lxup && start-hermes.bat"

echo [4/6] Starting License Server (9000)...
...
echo    License Server  http://127.0.0.1:9000   - license service
